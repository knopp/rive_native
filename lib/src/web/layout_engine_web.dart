...
late js.JSFunction _yogaStyleGetAspectRatio;
late js.JSFunction _yogaStyleSetAspectRatio;
...
class LayoutEngineWasm {
  static void link(js.JSObject module) {
    ...
    _yogaStyleGetAspectRatio =
        module['_yogaStyleGetAspectRatio'] as js.JSFunction;
    _yogaStyleSetAspectRatio =
        module['_yogaStyleSetAspectRatio'] as js.JSFunction;
...
class LayoutStyleWasm extends LayoutStyle {
  ...
  double? get aspectRatio {
    double value = (_yogaStyleGetAspectRatio.callAsFunction(
            null, _nativePtr.toJS) as js.JSNumber)
        .toDartDouble;
    if (value.isNaN) {
      return null;
  ...
  @override
  set aspectRatio(double? value) => _yogaStyleSetAspectRatio.callAsFunction(
      null, _nativePtr.toJS, (value ?? double.nan).toJS);
