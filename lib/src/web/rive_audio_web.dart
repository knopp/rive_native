...
class BufferedAudioSourceWasm extends BufferedAudioSource with AudioSourceWasm {
  ...
  BufferedAudioSourceWasm(this.nativePtr, this.dataLength, this.dataPtr);
...
class StreamingAudioSourceWasm extends StreamingAudioSource
  ...
  StreamingAudioSourceWasm(this.nativePtr);
...
class AudioSoundWasm extends AudioSound {
  ...
  @override
  void dispose() {
    _unrefAudioSound.callAsFunction(null, nativePtr.toJS);
    nativePtr = 0;
  }
...
class AudioEngineWasm extends AudioEngine {
  ...
  static void link(js.JSObject module) {
    ...
    _stopAudio = module['stopAudio'] as js.JSFunction;
  ...
  @override
  void monitorLevels() =>
      _engineInitLevelMonitor.callAsFunction(null, nativePtr.toJS);
