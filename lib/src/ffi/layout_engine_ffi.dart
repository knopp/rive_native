...
final bool Function(Pointer<Void>) _yogaNodeHasError = _nativeLib
    .lookup<
        NativeFunction<
            Bool Function(
              Pointer<Void>,
...
final double Function(Pointer<Void>) _yogaStyleGetAspectRatio = _nativeLib
    .lookup<NativeFunction<Float Function(Pointer<Void>)>>(
        'yogaStyleGetAspectRatio')
    .asFunction();

final void Function(Pointer<Void>, double) _yogaStyleSetAspectRatio = _nativeLib
    .lookup<NativeFunction<Void Function(Pointer<Void>, Float)>>(
        'yogaStyleSetAspectRatio')
    .asFunction();
...
class LayoutNodeFFI extends LayoutNode implements Finalizable {
  ...
  @override
  bool hasError() => _yogaNodeHasError(_nativePtr);
...
class LayoutStyleFFI extends LayoutStyle implements Finalizable {
  ...
  double? get aspectRatio {
    double value = _yogaStyleGetAspectRatio(_nativePtr);
    if (value.isNaN) {
      return null;
    }
    return value;
  ...
  set aspectRatio(double? value) =>
      _yogaStyleSetAspectRatio(_nativePtr, value ?? double.nan);
...
LayoutNode makeLayoutNodeExternal(dynamic ref) =>
    LayoutNodeFFI(ref as Pointer<Void>);
